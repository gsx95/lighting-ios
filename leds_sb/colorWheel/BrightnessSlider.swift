...
internal class BrightnessSlider: UIView {
    ...
    private lazy var scales: [CALayer] = {
        var scales = (0..<20).map { _ -> CALayer in
            let layer = CALayer()
            layer.backgroundColor = #colorLiteral(red: 0.1098039216, green: 0.1725490196, blue: 0.2352941176, alpha: 1).cgColor
            return layer
        }
        return scales
    }()
    ...
    private func updateShadowColor() {
        let bgColor: UIColor = #colorLiteral(red: 0.1098039216, green: 0.1725490196, blue: 0.2352941176, alpha: 1)
